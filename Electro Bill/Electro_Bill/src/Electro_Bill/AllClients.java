...
public class AllClients extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Show Blacklisted");
        ...
        jButton4.setText("Show Whitelisted");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Client c : clients) {
            details = (details + c.stringViewClientDetails()+ "\n");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DB db = new DB();
        ArrayList<Client> clients = db.getAllBlacklistedClients();
        String details = "";
        for (Client c : clients) {
            details = (details + c.stringViewClientDetails()+ "\n");
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        DB db = new DB();
        ArrayList<Client> clients = db.getAllWhitelistedClients();
        String details = "";
        for (Client c : clients) {
            details = (details + c.stringViewClientDetails()+ "\n");
        }
