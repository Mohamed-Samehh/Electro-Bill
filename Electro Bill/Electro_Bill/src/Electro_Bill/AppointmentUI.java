...
public class AppointmentUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("View Upcoming");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        DB db = new DB();
        ArrayList<Appointment> Appointed = db.getAllAppointmentsByCID(Current.currentCID);
        String details = "";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.setVisible(false);
        UpdateAppointment newDate = new UpdateAppointment();
        newDate.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        DB db = new DB();
        ArrayList<Appointment> Appointed = db.getUpcomingAppointmentsByCID(Current.currentCID);
        String details = "";
        for (Appointment a : Appointed) {
            details = (details + a.stringViewAppointmentDetails() + "\n");
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        DB db = new DB();
        ArrayList<Appointment> Appointed = db.getPastAppointmentsByCID(Current.currentCID);
        String details = "";
        for (Appointment a : Appointed) {
            details = (details + a.stringViewAppointmentDetails() + "\n");
        }
