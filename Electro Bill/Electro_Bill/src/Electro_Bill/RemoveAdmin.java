...
public class RemoveAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!"".equals(idtxt)){
            ...
            Admin admin = db.getAdmin(id);
            Admin current = db.getAdmin(Current.currentAID);

            if(admin != null){
                if(current.getId() != admin.getId()) {
                    db.removeAdmin(id);
                    JOptionPane.showMessageDialog(this, "Admin removed");
                }
                else{
                    JOptionPane.showMessageDialog(this, "You can't remove yourself");
                }
            }
            else{
