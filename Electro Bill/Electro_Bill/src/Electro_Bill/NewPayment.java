...
public class NewPayment extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cardHolder = jTextField2.getText();
        String cvv = jTextField3.getText();
        String b = jTextField4.getText();
        
        
        if(!"".equals(cardNo) && !"".equals(cardHolder) && !"".equals(cvv) && !"".equals(b)){
            int BillID = parseInt(b);
            if(db.getBill(BillID) != null){
                double amount = db.getBill(BillID).getAmount();
                Payment p = new Payment(0, cardNo, cardHolder, cvv, amount, Current.currentCID, BillID);
                db.addPayment(p);
                try {
                    if(db.getLastPayment().getClientID() == db.getBill(BillID).getClientID()){
                        String s = db.stringMarkBillPaid(BillID);
                        Details.setText(s);
                        if(db.getClient(Current.currentCID) == null){
                        ...
                        JOptionPane.showMessageDialog(this, "You can only pay your bills, not others");
                    }
                ...
                JOptionPane.showMessageDialog(this, "Bill doesn't exist!");
            }
        }
        else{
